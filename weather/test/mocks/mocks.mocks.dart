...
// in weather/test/tools/mocks.dart.
...
class MockWeatherRepository extends _i1.Mock implements _i4.WeatherRepository {
  ...
  @override
  _i5.Future<_i2.Result<_i6.Weather>> getCurrentWeather(
    double? lat,
    double? lon,
  ) =>
      (super.noSuchMethod(
        ...
        returnValue: _i5.Future<_i2.Result<_i6.Weather>>.value(
            _FakeResult_0<_i6.Weather>(
          this,
          Invocation.method(
            #getCurrentWeather,
            [
      ...
      ) as _i5.Future<_i2.Result<_i6.Weather>>);
}
